                ...
                if (className.startsWith(skillPackageName)) {
                    ...
                    try {
                        ...
                        if (Skill::class.java.isAssignableFrom(loadedClass) && !loadedClass.isInterface && !java.lang.reflect.Modifier.isAbstract(loadedClass.modifiers)) {
                            val constructor = loadedClass.getConstructor(Context::class.java, Robot::class.java, UIHelper::class.java)
                            val skillInstance = constructor.newInstance(context, robot, uiHelper) as Skill
