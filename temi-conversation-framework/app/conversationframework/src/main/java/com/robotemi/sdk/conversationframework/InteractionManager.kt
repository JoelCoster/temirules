    ...
    return when (expr) {
        ...
        is FunctionCall -> {
            ...
            val receiverInstance = when (expr.receiver) {
                ...
                "TTS", "TiltHead", "ASR", "Move", "Locations", "System", "HuggingFace" -> context.skillManager
            ...
            return if (expr.receiver == "TTS" || expr.receiver == "TiltHead" || expr.receiver == "ASR" || expr.receiver == "Move" || expr.receiver == "Locations" || expr.receiver == "System" || expr.receiver == "HuggingFace") {
...
class InteractionManager : AppCompatActivity(), OnRobotReadyListener, Robot.AsrListener, Robot.TtsListener, 
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        skillManager.loadSkill("System")
        skillManager.loadSkill("HuggingFace")
    }
